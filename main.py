...
def on_a_pressed():
    global numberOfJumps
    if mySprite.is_hitting_tile(CollisionDirection.BOTTOM):
        mySprite.vy = -175
        numberOfJumps = 1
    elif numberOfJumps == 1:
        mySprite.vy = -175
        numberOfJumps = 0
...
mySprite = sprites.create(assets.image("""
    dino
"""), SpriteKind.player)
tiles.place_on_tile(mySprite, tiles.get_tile_location(3, 5))
mySprite.ay = 500
...
def on_update_interval():
    ...
    coin_item = sprites.create(img("""
        ...
        """),
        SpriteKind.Coin)
    tiles.place_on_tile(coin_item, tiles.get_tile_location(10, 2))
    coin_item.set_velocity(-40, 0)
game.on_update_interval(randint(6000, 12000), on_update_interval)
...
def on_update_interval2():
    ...
    projectile = sprites.create_projectile_from_side(img("""
        ...
        randint(-120, -75),
        0)
    tiles.place_on_tile(projectile, tiles.get_tile_location(10, 5))
    info.change_score_by(1)
game.on_update_interval(randint(1500, 2500), on_update_interval2)
